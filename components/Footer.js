...
const Footer = () => {
  return (
    <footer className="bg-[#64B6AC] text-center p-4 w-full relative bottom-0">
      <div className="flex flex-col md:flex-row justify-between items-center flex-wrap w-full max-w-screen-xl ml-5 mr-5 px-5">
